document.addEventListener("DOMContentLoaded", function() {
    window.addEventListener('load', function() {
        UAGBCounter.init('.uagb-block-e6f5bf6c', {
            "layout": "number",
    ...
    window.addEventListener('load', function() {
        UAGBCounter.init('.uagb-block-8a7cf7d8', {
            "layout": "number",
    ...
    jQuery(document).ready(function() {
        if (jQuery('.uagb-block-63c466d1').length > 0) {
            jQuery('.uagb-block-63c466d1').find(".is-carousel").slick({
                "slidesToShow": 1,
                "slidesToScroll": 1,
                "autoplaySpeed": "2000",
                "autoplay": true,
    ...
    jQuery(document).ready(function() {
        if (jQuery('.uagb-block-f2a15cbe').length > 0) {
            jQuery('.uagb-block-f2a15cbe').find(".is-carousel").slick({
                "slidesToShow": 1,
                "slidesToScroll": 1,
                "autoplaySpeed": "2000",
                "autoplay": true,
